(function(root, factory) {
  if (typeof define === 'function' && define.amd) 
    define(['exports', 'kotlin', 'kotlinx-io', 'kotlinx-io-kotlinx-coroutines-io', 'kotlinx-coroutines-core'], factory);
  else if (typeof exports === 'object') 
    factory(module.exports, require('kotlin'), require('kotlinx-io'), require('kotlinx-io-kotlinx-coroutines-io'), require('kotlinx-coroutines-core'));
  else {
    ...
    if (typeof this['kotlinx-io-kotlinx-coroutines-io'] === 'undefined') {
      throw new Error("Error loading module 'ktor-ktor-utils'. Its dependency 'kotlinx-io-kotlinx-coroutines-io' was not found. Please, check whether 'kotlinx-io-kotlinx-coroutines-io' is loaded prior to 'ktor-ktor-utils'.");
    }
    ...
    root['ktor-ktor-utils'] = factory(typeof this['ktor-ktor-utils'] === 'undefined' ? {} : this['ktor-ktor-utils'], kotlin, this['kotlinx-io'], this['kotlinx-io-kotlinx-coroutines-io'], this['kotlinx-coroutines-core']);
  }
}(this, function(_, Kotlin, $module$kotlinx_io, $module$kotlinx_io_kotlinx_coroutines_io, $module$kotlinx_coroutines_core) {
  'use strict';
  ...
  var readRemaining = $module$kotlinx_io_kotlinx_coroutines_io.kotlinx.coroutines.io.readRemaining_5joj65$;
  ...
  var readRemaining_0 = $module$kotlinx_io_kotlinx_coroutines_io.kotlinx.coroutines.io.readRemaining_ep79e2$;
