        ...
        eachPlugin {
            ...
            when (requested.id.id) {
                ...
                "org.jetbrains.kotlin.plugin.spring", "org.jetbrains.kotlin.plugin.jpa" ->
                    useModule("org.jetbrains.kotlin:kotlin-noarg:$kotlinVersion")
                "com.android.application", "com.android.library" ->
                    useModule("com.android.tools.build:gradle:$androidGradlePluginVersion")
                "com.google.gms.google-services" ->
                    useModule("com.google.gms:google-services:$gmsGradlePluginVersion")
                "org.jetbrains.kotlin.plugin.serialization" ->
                    useModule("org.jetbrains.kotlin:kotlin-serialization:$kotlinVersion")
                "com.moowork.node" ->
                    useModule("com.moowork.gradle:gradle-node-plugin:$nodePluginVersion")
                "com.github.node-gradle.node" ->
                    useModule("com.github.node-gradle:gradle-node-plugin:$nodePluginForkVersion")
                "org.springframework.boot" ->
                    useModule("org.springframework.boot:spring-boot-gradle-plugin:$springframeworkBootVersion")
            }
        }
    }
