...
external interface FactoryProvider : FactorySansProvider {
    var provide: Any
    var multi: Boolean?
        get() = definedExternally
        set(value) = definedExternally
...
open external class InjectionToken<T>(_desc: String, options: `T$8`? = definedExternally) {
...
@Suppress("NESTED_CLASS_IN_EXTERNAL_INTERFACE")
external interface Type<T> : Function {
    companion object : FunctionConstructor by definedExternally
}
...
external interface ValueProvider : ValueSansProvider {
    var provide: Any
    var multi: Boolean?
        get() = definedExternally
        set(value) = definedExternally
...
external interface ValueSansProvider {
    var useValue: Any
}
