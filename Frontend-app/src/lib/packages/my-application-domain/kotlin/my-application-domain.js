(function (root, factory) {
  ...
  function GetAllMatchesByUserUseCase(repository, getUserInfo) {
    this.repository_0 = repository;
    this.getUserInfo_0 = getUserInfo;
  }
      ...
      try {
        switch (this.state_0) {
          case 0:
            ...
            this.state_0 = 2;
            this.result_0 = this.local$this$GetAllMatchesByUserUseCase.getUserInfo_0.buildAction(this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  function GetCreatedTournamentsByAdminUseCase(repository, getUserInfo) {
    this.repository_0 = repository;
    this.getUserInfo_0 = getUserInfo;
  }
      ...
      try {
        switch (this.state_0) {
          case 0:
            ...
            this.state_0 = 2;
            this.result_0 = this.local$this$GetCreatedTournamentsByAdminUseCase.getUserInfo_0.buildAction(this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  CreateUserUseCase.prototype.buildAction_11rb$ = function (params, continuation) {
    return this.repository_0.createUser_w74nik$(params.email, params.password, params.nickname, params.image, continuation);
  };
  ...
  function GetUserInfoUseCase(repository) {
    this.repository_0 = repository;
  }
  GetUserInfoUseCase.prototype.buildAction = function (continuation) {
    return this.repository_0.getCurrentUser(continuation);
  };
  GetUserInfoUseCase.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'GetUserInfoUseCase',
    interfaces: [UseCaseSuspending]
  };
  ...
  function Coroutine$JsCreateUser$buildAction$lambda(this$JsCreateUser_0, closure$params_0, $receiver_0, controller, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.$controller = controller;
    this.exceptionState_0 = 1;
    this.local$this$JsCreateUser = this$JsCreateUser_0;
    this.local$closure$params = closure$params_0;
  }
    ...
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = this.local$this$JsCreateUser.usecase.buildAction_11rb$(this.local$closure$params, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  function JsCreateUser$buildAction$lambda(this$JsCreateUser_0, closure$params_0) {
    return function ($receiver_0, continuation_0, suspended) {
      var instance = new Coroutine$JsCreateUser$buildAction$lambda(this$JsCreateUser_0, closure$params_0, $receiver_0, this, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  JsCreateUser.prototype.buildAction_11rc$ = function (params) {
    return promise(coroutines.GlobalScope, void 0, void 0, JsCreateUser$buildAction$lambda(this, params));
  };
  ...
  function Coroutine$JsIsSubscribedAccount$buildAction$lambda(this$JsIsSubscribedAccount_0, closure$params_0, $receiver_0, controller, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.$controller = controller;
    this.exceptionState_0 = 1;
    this.local$this$JsIsSubscribedAccount = this$JsIsSubscribedAccount_0;
    this.local$closure$params = closure$params_0;
  }
    ...
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = this.local$this$JsIsSubscribedAccount.usecase.buildAction_11rb$(this.local$closure$params, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  function JsIsSubscribedAccount$buildAction$lambda(this$JsIsSubscribedAccount_0, closure$params_0) {
    return function ($receiver_0, continuation_0, suspended) {
      var instance = new Coroutine$JsIsSubscribedAccount$buildAction$lambda(this$JsIsSubscribedAccount_0, closure$params_0, $receiver_0, this, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  JsIsSubscribedAccount.prototype.buildAction_11rc$ = function (params) {
    return promise(coroutines.GlobalScope, void 0, void 0, JsIsSubscribedAccount$buildAction$lambda(this, params));
  };
  ...
  package$user.GetUserInfoUseCase = GetUserInfoUseCase;
