(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    define(['exports', 'kotlin', 'klock-root-klock', 'ktor-ktor-http', 'my-application-domain', 'kotlinx-serialization-kotlinx-serialization-runtime', 'kotlinx-coroutines-core'], factory);
  else if (typeof exports === 'object')
    factory(module.exports, require('kotlin'), require('klock-root-klock'), require('ktor-ktor-http'), require('my-application-domain'), require('kotlinx-serialization-kotlinx-serialization-runtime'), require('kotlinx-coroutines-core'));
  else {
    ...
    root['my-application-data'] = factory(typeof this['my-application-data'] === 'undefined' ? {} : this['my-application-data'], kotlin, this['klock-root-klock'], this['ktor-ktor-http'], this['my-application-domain'], this['kotlinx-serialization-kotlinx-serialization-runtime'], this['kotlinx-coroutines-core']);
  }
}(this, function (_, Kotlin, $module$klock_root_klock, $module$ktor_ktor_http, $module$my_application_domain, $module$kotlinx_serialization_kotlinx_serialization_runtime, $module$kotlinx_coroutines_core) {
  'use strict';
  ...
  function Coroutine$createUser_w74nik$($this, email_0, password_0, nickname_0, image_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.$this = $this;
    this.local$email = email_0;
    this.local$password = password_0;
    this.local$nickname = nickname_0;
    this.local$image = image_0;
  }
  Coroutine$createUser_w74nik$.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$createUser_w74nik$.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$createUser_w74nik$.prototype.constructor = Coroutine$createUser_w74nik$;
  Coroutine$createUser_w74nik$.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = this.$this.atDS_0.createUser_qr3sts$(new CreateUserJSON(this.local$email, this.local$password, this.local$nickname, this.local$image), this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  ArenaTournamentRepositoryImplementation.prototype.createUser_w74nik$ = function (email_0, password_0, nickname_0, image_0, continuation_0, suspended) {
    var instance = new Coroutine$createUser_w74nik$(this, email_0, password_0, nickname_0, image_0, continuation_0);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  ...
  package$datasource.TokenFactory = TokenFactory;
