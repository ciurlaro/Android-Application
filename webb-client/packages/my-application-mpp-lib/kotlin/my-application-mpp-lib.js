(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    define(['exports', 'kotlin', 'kotlinx-serialization-kotlinx-serialization-runtime', 'my-application-data', 'ktor-ktor-client-core', 'ktor-ktor-http', 'ktor-ktor-utils', 'my-application-domain', 'Kodein-DI-kodein-di-erased', 'ktor-ktor-client-logging', 'Kodein-DI-kodein-di-core', 'ktor-ktor-client-mock', 'ktor-ktor-client-json', 'ktor-ktor-client-serialization', 'firebase', 'kotlinx-coroutines-core'], factory);
  else if (typeof exports === 'object')
    factory(module.exports, require('kotlin'), require('kotlinx-serialization-kotlinx-serialization-runtime'), require('my-application-data'), require('ktor-ktor-client-core'), require('ktor-ktor-http'), require('ktor-ktor-utils'), require('my-application-domain'), require('Kodein-DI-kodein-di-erased'), require('ktor-ktor-client-logging'), require('Kodein-DI-kodein-di-core'), require('ktor-ktor-client-mock'), require('ktor-ktor-client-json'), require('ktor-ktor-client-serialization'), require('firebase'), require('kotlinx-coroutines-core'));
  else {
    ...
    if (typeof this['ktor-ktor-client-logging'] === 'undefined') {
      throw new Error("Error loading module 'my-application-mpp-lib'. Its dependency 'ktor-ktor-client-logging' was not found. Please, check whether 'ktor-ktor-client-logging' is loaded prior to 'my-application-mpp-lib'.");
    }
    ...
    if (typeof this['ktor-ktor-client-mock'] === 'undefined') {
      throw new Error("Error loading module 'my-application-mpp-lib'. Its dependency 'ktor-ktor-client-mock' was not found. Please, check whether 'ktor-ktor-client-mock' is loaded prior to 'my-application-mpp-lib'.");
    }
    ...
    if (typeof firebase === 'undefined') {
      throw new Error("Error loading module 'my-application-mpp-lib'. Its dependency 'firebase' was not found. Please, check whether 'firebase' is loaded prior to 'my-application-mpp-lib'.");
    }
    if (typeof this['kotlinx-coroutines-core'] === 'undefined') {
      throw new Error("Error loading module 'my-application-mpp-lib'. Its dependency 'kotlinx-coroutines-core' was not found. Please, check whether 'kotlinx-coroutines-core' is loaded prior to 'my-application-mpp-lib'.");
    }
    root['my-application-mpp-lib'] = factory(typeof this['my-application-mpp-lib'] === 'undefined' ? {} : this['my-application-mpp-lib'], kotlin, this['kotlinx-serialization-kotlinx-serialization-runtime'], this['my-application-data'], this['ktor-ktor-client-core'], this['ktor-ktor-http'], this['ktor-ktor-utils'], this['my-application-domain'], this['Kodein-DI-kodein-di-erased'], this['ktor-ktor-client-logging'], this['Kodein-DI-kodein-di-core'], this['ktor-ktor-client-mock'], this['ktor-ktor-client-json'], this['ktor-ktor-client-serialization'], firebase, this['kotlinx-coroutines-core']);
  }
}(this, function (_, Kotlin, $module$kotlinx_serialization_kotlinx_serialization_runtime, $module$my_application_data, $module$ktor_ktor_client_core, $module$ktor_ktor_http, $module$ktor_ktor_utils, $module$my_application_domain, $module$Kodein_DI_kodein_di_erased, $module$ktor_ktor_client_logging, $module$Kodein_DI_kodein_di_core, $module$ktor_ktor_client_mock, $module$ktor_ktor_client_json, $module$ktor_ktor_client_serialization, $module$firebase, $module$kotlinx_coroutines_core) {
  'use strict';
  ...
  var AuthException = $module$my_application_domain.com.example.myapplication.exceptions.AuthException;
  ...
  var AuthenticationManager = $module$my_application_domain.com.example.myapplication.auth.AuthenticationManager;
  ...
  var LogLevel = $module$ktor_ktor_client_logging.io.ktor.client.features.logging.LogLevel;
  ...
  var MockEngine = $module$ktor_ktor_client_mock.io.ktor.client.engine.mock.MockEngine;
  ...
  var headersOf = $module$ktor_ktor_http.io.ktor.http.headersOf_cjfssn$;
  var respond = $module$ktor_ktor_client_mock.io.ktor.client.engine.mock.respond_eywny9$;
  var get_fullPath = $module$ktor_ktor_http.io.ktor.http.get_fullPath_5y8s0c$;
  var HttpMethod_0 = $module$ktor_ktor_http.io.ktor.http.HttpMethod;
  ...
  var Logging = $module$ktor_ktor_client_logging.io.ktor.client.features.logging.Logging;
  var HttpClient_1 = $module$ktor_ktor_client_core.io.ktor.client.HttpClient_f0veat$;
  ...
  var GetCurrentUserInfoUseCase = $module$my_application_domain.com.example.myapplication.usecases.user.GetCurrentUserInfoUseCase;
  ...
  var auth = $module$firebase.auth;
  var AuthException$AuthNotAuthenticatedException = $module$my_application_domain.com.example.myapplication.exceptions.AuthException.AuthNotAuthenticatedException;
  var credential = $module$firebase.firebase.auth.EmailAuthProvider.credential;
  var credential_0 = $module$firebase.firebase.auth.FacebookAuthProvider.credential;
  var credential_1 = $module$firebase.firebase.auth.GoogleAuthProvider.credential;
  var await_0 = $module$kotlinx_coroutines_core.kotlinx.coroutines.await_t11jrl$;
  var AuthUserEntity = $module$my_application_domain.com.example.myapplication.entities.AuthUserEntity;
  var AuthProviders = $module$my_application_domain.com.example.myapplication.entities.AuthProviders;
  var equals = Kotlin.equals;
  var AuthException$AuthWeakPasswordException = $module$my_application_domain.com.example.myapplication.exceptions.AuthException.AuthWeakPasswordException;
  var AuthException$AuthInvalidCredentialsException = $module$my_application_domain.com.example.myapplication.exceptions.AuthException.AuthInvalidCredentialsException;
  var AuthException$AuthUserCollisionException = $module$my_application_domain.com.example.myapplication.exceptions.AuthException.AuthUserCollisionException;
  var AuthException$AuthInvalidUserException = $module$my_application_domain.com.example.myapplication.exceptions.AuthException.AuthInvalidUserException;
  var AuthException$AuthRecentLoginRequiredException = $module$my_application_domain.com.example.myapplication.exceptions.AuthException.AuthRecentLoginRequiredException;
  var AuthException$AuthGenericException = $module$my_application_domain.com.example.myapplication.exceptions.AuthException.AuthGenericException;
  ...
  function ArenaTournamentDatasourceImplementation$authenticatedPost$lambda(closure$continuation, this$ArenaTournamentDatasourceImplementation, closure$content) {
    return function ($receiver) {
      this$ArenaTournamentDatasourceImplementation.addAuth_0($receiver, closure$continuation);
  ...
  function ArenaTournamentDatasourceImplementation$authenticatedGet$lambda(closure$continuation, this$ArenaTournamentDatasourceImplementation) {
    return function ($receiver) {
      this$ArenaTournamentDatasourceImplementation.addAuth_0($receiver, closure$continuation);
      return Unit;
    };
  }
  function ArenaTournamentDatasourceImplementation(httpClient, endpoints, authManager) {
    this.httpClient_0 = httpClient;
    this.endpoints_0 = endpoints;
    this.authManager_0 = authManager;
  }
      ...
      try {
        switch (this.state_0) {
          case 0:
            ...
            ArenaTournamentDatasourceImplementation$authenticatedPost$lambda(this, this.$this, content)($receiver_1);
            this.state_0 = 2;
      ...
      try {
        switch (this.state_0) {
          case 0:
            ...
            $receiver_1.body = body_0;
            takeFrom($receiver_1.url, url_0);
            ArenaTournamentDatasourceImplementation$authenticatedGet$lambda(this, this.$this)($receiver_1);
            this.state_0 = 2;
            this.result_0 = call($receiver, $receiver_1, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
      ...
      try {
        switch (this.state_0) {
          case 0:
            ...
            $receiver_1.body = body_0;
            takeFrom($receiver_1.url, this.local$url);
            ArenaTournamentDatasourceImplementation$authenticatedPost$lambda(this, this.$this, this.local$content)($receiver_1);
            this.state_0 = 2;
            this.result_0 = call(this.local$$receiver, $receiver_1, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
  ...
  function Coroutine$addAuth_0($this, $receiver_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
  ...
  Coroutine$addAuth_0.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$addAuth_0.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$addAuth_0.prototype.constructor = Coroutine$addAuth_0;
  Coroutine$addAuth_0.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            this.exceptionState_0 = 2;
            this.local$tmp$ = http.HttpHeaders.Authorization;
            this.state_0 = 1;
            this.result_0 = this.$this.authManager_0.getToken(this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
            header(this.local$$receiver, this.local$tmp$, 'Bearer: ' + encodeBase64(this.result_0 + ':'));
            this.exceptionState_0 = 4;
            this.state_0 = 3;
            continue;
          case 2:
            ...
            if (Kotlin.isType(e, AuthException)) {
              println(e);
            }
             else
              throw e;
  ...
  ArenaTournamentDatasourceImplementation.prototype.addAuth_0 = function ($receiver_0, continuation_0, suspended) {
    var instance = new Coroutine$addAuth_0(this, $receiver_0, continuation_0);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  ...
  function AuthModule() {
    AuthModule_instance = this;
  }
  function AuthModule$provideModule$lambda$lambda($receiver) {
    return getFirebaseAuthInstance();
  }
  function AuthModule$provideModule$lambda$lambda_0($receiver) {
    var tmp$ = $receiver.dkodein;
    var erased$result;
    try {
      erased$result = new JSTypeToken_init(getKClass(FirebaseAuth));
    }
     catch (ex) {
    ...
    return new FirebaseAuthenticationManager(tmp$.Instance_xflu9r$(erased$result, null));
  }
  function AuthModule$provideModule$lambda($receiver) {
    var erased$result;
    try {
      erased$result = new JSTypeToken_init(getKClass(FirebaseAuth));
    }
    ...
    var erased$result_0;
    try {
      erased$result_0 = new JSTypeToken_init(getKClass(FirebaseAuth));
    }
     catch (ex_0) {
    ...
    tmp$.with_byf4r2$(new Singleton_init(tmp$_0, tmp$_0_0, erased$result_0, null, true, AuthModule$provideModule$lambda$lambda));
    var erased$result_1;
    try {
      erased$result_1 = new JSTypeToken_init(getKClass(AuthenticationManager));
    }
     catch (ex_1) {
    ...
    var erased$result_2;
    try {
      erased$result_2 = new JSTypeToken_init(getKClass(FirebaseAuthenticationManager));
    }
     catch (ex_2) {
    ...
    tmp$_1.with_byf4r2$(new Singleton_init(tmp$_2, tmp$_0_1, erased$result_2, null, true, AuthModule$provideModule$lambda$lambda_0));
    return Unit;
  }
  AuthModule.prototype.provideModule = function () {
    return AuthModule$provideModule$lambda;
  };
  AuthModule.$metadata$ = {
    kind: Kind_OBJECT,
    simpleName: 'AuthModule',
    interfaces: [KodeinModuleProvider]
  };
  var AuthModule_instance = null;
  function AuthModule_getInstance() {
    if (AuthModule_instance === null) {
      new AuthModule();
    }
    return AuthModule_instance;
  }
  function buildCommonKodein$lambda(closure$serverProtocol, closure$serverUrl, closure$serverPort, closure$isDebug, closure$networkLogLevel, closure$isMock) {
    return function ($receiver) {
      ...
      import_1($receiver, AuthModule_getInstance());
      ...
      var $receiver_3 = $receiver.constant_obdoaf$('isDebug');
      var value_2 = closure$isDebug;
      var erased$result_2;
      try {
        erased$result_2 = new JSTypeToken_init(PrimitiveClasses$booleanClass);
      }
       catch (ex_2) {
        if (Kotlin.isType(ex_2, Throwable)) {
          throw IllegalArgumentException_init('Could not get KClass. Note that Kotlin does NOT support reflection over primitives.');
      ...
      $receiver_3.With_xhfjco$(erased$result_2, value_2);
      if (closure$isDebug) {
        var $receiver_4 = $receiver.constant_obdoaf$('networkLogLevel');
        var value_3 = closure$networkLogLevel;
        var erased$result_3;
        try {
          erased$result_3 = new JSTypeToken_init(getKClass(LogLevel));
        }
         catch (ex_3) {
        ...
        $receiver_4.With_xhfjco$(erased$result_3, value_3);
      }
      if (closure$isMock) {
        import_1($receiver, CommonMockModule_getInstance());
        import_1($receiver, PlatformSpecificMockModule_getInstance());
      }
      return Unit;
    };
  }
  function buildCommonKodein(serverProtocol, serverUrl, serverPort, isMock, isDebug, networkLogLevel) {
    if (isMock === void 0)
      isMock = false;
    if (isDebug === void 0)
      isDebug = false;
    if (networkLogLevel === void 0)
      networkLogLevel = LogLevel.ALL;
    return new Kodein$Module('COMMON_KODEIN', void 0, void 0, buildCommonKodein$lambda(serverProtocol, serverUrl, serverPort, isDebug, networkLogLevel, isMock));
  }
  function CommonMockModule() {
    CommonMockModule_instance = this;
  }
  function CommonMockModule$provideModule$lambda$lambda$lambda$lambda($receiver) {
    $receiver.serializer = new KotlinxSerializer();
    return Unit;
  }
  function Coroutine$CommonMockModule$provideModule$lambda$lambda$lambda$lambda$lambda(this$_0, this$CommonMockModule_0, it_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.local$this$ = this$_0;
    this.local$this$CommonMockModule = this$CommonMockModule_0;
    this.local$it = it_0;
  }
  Coroutine$CommonMockModule$provideModule$lambda$lambda$lambda$lambda$lambda.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$CommonMockModule$provideModule$lambda$lambda$lambda$lambda$lambda.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$CommonMockModule$provideModule$lambda$lambda$lambda$lambda$lambda.prototype.constructor = Coroutine$CommonMockModule$provideModule$lambda$lambda$lambda$lambda$lambda;
  Coroutine$CommonMockModule$provideModule$lambda$lambda$lambda$lambda$lambda.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            return this.local$this$CommonMockModule.handleMockEngineRequest_0(this.local$it, this.local$this$.dkodein);
          case 1:
            throw this.exception_0;
          default:this.state_0 = 1;
            throw new Error('State Machine Unreachable execution');
  ...
  function CommonMockModule$provideModule$lambda$lambda$lambda$lambda$lambda(this$_0, this$CommonMockModule_0) {
    return function (it_0, continuation_0, suspended) {
      var instance = new Coroutine$CommonMockModule$provideModule$lambda$lambda$lambda$lambda$lambda(this$_0, this$CommonMockModule_0, it_0, continuation_0);
      if (suspended)
        return instance;
      else
        return instance.doResume(null);
  ...
  function CommonMockModule$provideModule$lambda$lambda$lambda$lambda_0(this$, this$CommonMockModule) {
    return function ($receiver) {
      $receiver.addHandler_y7mm6y$(CommonMockModule$provideModule$lambda$lambda$lambda$lambda$lambda(this$, this$CommonMockModule));
      return Unit;
    };
  }
  function CommonMockModule$provideModule$lambda$lambda$lambda(this$, this$CommonMockModule) {
    return function ($receiver) {
      $receiver.install_xlxg29$(JsonFeature.Feature, CommonMockModule$provideModule$lambda$lambda$lambda$lambda);
      $receiver.engine_dxyxif$(CommonMockModule$provideModule$lambda$lambda$lambda$lambda_0(this$, this$CommonMockModule));
      return Unit;
    };
  }
  function CommonMockModule$provideModule$lambda$lambda(this$CommonMockModule) {
    return function ($receiver) {
      return HttpClient_0(MockEngine.Companion, CommonMockModule$provideModule$lambda$lambda$lambda($receiver, this$CommonMockModule));
    };
  }
  function CommonMockModule$provideModule$lambda(this$CommonMockModule) {
    return function ($receiver) {
      var erased$result;
      try {
      ...
      var tmp$ = $receiver.Bind_lpxwra$(erased$result, null, true);
      var creator = CommonMockModule$provideModule$lambda$lambda(this$CommonMockModule);
      var tmp$_0 = $receiver.scope;
      var tmp$_0_0 = $receiver.contextType;
      var erased$result_0;
      try {
  ...
  CommonMockModule.prototype.provideModule = function () {
    return CommonMockModule$provideModule$lambda(this);
  };
  CommonMockModule.prototype.respondJsonFromRawResources_0 = function (jsonName, dKodein) {
    var tmp$ = dKodein.dkodein;
    var erased$result;
    try {
      erased$result = new JSTypeToken_init(PrimitiveClasses$stringClass);
    }
    ...
    return respond(tmp$.Instance_xflu9r$(erased$result, jsonName), void 0, headersOf([to(http.HttpHeaders.ContentType, listOf(ContentType.Application.Json.toString()))]));
  };
  CommonMockModule.prototype.buildMockEngineError_0 = function (request) {
    throw IllegalStateException_init((request.toString() + ' cannot be handled by the mock engine').toString());
  };
  CommonMockModule.prototype.handleMockEngineRequest_0 = function (request, dKodein) {
    var tmp$, tmp$_0, tmp$_1, tmp$_2, tmp$_3;
    switch (get_fullPath(request.url)) {
      case '/game':
        return ((tmp$ = request.method) != null ? tmp$.equals(HttpMethod_0.Companion.Get) : null) ? this.respondJsonFromRawResources_0('multiple_game_responses', dKodein) : this.respondJsonFromRawResources_0('single_game_response', dKodein);
      case '/game/COD':
        return this.respondJsonFromRawResources_0('single_game_response', dKodein);
      case '/game/search/byGameName':
        return this.respondJsonFromRawResources_0('single_game_response', dKodein);
      case '/game/search/byMode?available_modes_mode_name=Free4All&page=0':
        return this.respondJsonFromRawResources_0('multiple_game_responses', dKodein);
      case '/game/search/byMode?available_modes_mode_name=Free4All&page=1':
        return this.respondJsonFromRawResources_0('multiple_game_responses', dKodein);
      case '/game/search/containingGameName?gameName=COD&page=0':
        return this.respondJsonFromRawResources_0('multiple_game_responses', dKodein);
      case '/game/search/containingGameName?gameName=COD&page=1':
        return this.respondJsonFromRawResources_0('multiple_game_responses', dKodein);
      case '/game?name=&availableModes&image&icon':
        return this.respondJsonFromRawResources_0('single_game_response', dKodein);
      case '/mode':
        return ((tmp$_0 = request.method) != null ? tmp$_0.equals(HttpMethod_0.Companion.Get) : null) ? this.respondJsonFromRawResources_0('multiple_game_modes_response', dKodein) : this.respondJsonFromRawResources_0('single_game_mode_response', dKodein);
      case '/tournament/1/game':
        return this.respondJsonFromRawResources_0('single_game_response', dKodein);
      case '/tournament':
        return ((tmp$_1 = request.method) != null ? tmp$_1.equals(HttpMethod_0.Companion.Get) : null) ? this.respondJsonFromRawResources_0('multiple_tournaments_response', dKodein) : this.respondJsonFromRawResources_0('single_tournament_response', dKodein);
      case '/tournament/1':
        return this.respondJsonFromRawResources_0('single_tournament_response', dKodein);
      case '/tournament/2':
        return this.respondJsonFromRawResources_0('single_tournament_response', dKodein);
      case '/tournament/2/game':
        return this.respondJsonFromRawResources_0('single_game_response', dKodein);
      case '/tournament/2/admin':
        return this.respondJsonFromRawResources_0('user_response', dKodein);
      case '/tournament/search/byMode':
        return this.respondJsonFromRawResources_0('multiple_tournaments_response', dKodein);
      case '/tournament/search/byGame':
        return this.respondJsonFromRawResources_0('multiple_tournaments_response', dKodein);
      case '/tournament/search/byGame?game=Cesare_1&page=0':
        return this.respondJsonFromRawResources_0('multiple_tournaments_response', dKodein);
      case '/tournament/search/byGame?game=Cesare_1&page=1':
        return this.respondJsonFromRawResources_0('multiple_tournaments_response', dKodein);
      case '/tournament/search/byName':
        return this.respondJsonFromRawResources_0('multiple_tournaments_response', dKodein);
      case '/tournament/search/byShowCase?page=0':
        return this.respondJsonFromRawResources_0('multiple_tournaments_response', dKodein);
      case '/tournament/search/byShowCase?page=1':
        return this.respondJsonFromRawResources_0('multiple_tournaments_response', dKodein);
      case '/tournament/search/byGame?gameName=wow&page=0':
        return this.respondJsonFromRawResources_0('multiple_tournaments_response', dKodein);
      case '/tournament/search/byGame?gameName=wow&page=1':
        return this.respondJsonFromRawResources_0('multiple_tournaments_response', dKodein);
      case '/tournament/search/byUserId?admin=Cesare_1&page=0':
        return this.respondJsonFromRawResources_0('multiple_tournaments_response', dKodein);
      case '/tournament/search/byUserId?admin=Cesare_1&page=1':
        return this.respondJsonFromRawResources_0('multiple_tournaments_response', dKodein);
      case '/tournament/search/byMode?tournamentMode=F4A&page=0':
        return this.respondJsonFromRawResources_0('multiple_tournaments_response', dKodein);
      case '/tournament/search/byMode?tournamentMode=F4A&page=1':
        return this.respondJsonFromRawResources_0('multiple_tournaments_response', dKodein);
      case '/tournament/search/containingTitle?title=42&page=0':
        return this.respondJsonFromRawResources_0('multiple_tournaments_response', dKodein);
      case '/tournament/search/containingTitle?title=42&page=1':
        return this.respondJsonFromRawResources_0('multiple_tournaments_response', dKodein);
      case '/match/1/tournament':
        return this.respondJsonFromRawResources_0('single_tournament_response', dKodein);
      case '/match/2/tournament':
        return this.respondJsonFromRawResources_0('single_tournament_response', dKodein);
      case '/match':
        if ((tmp$_2 = request.method) != null ? tmp$_2.equals(HttpMethod_0.Companion.Get) : null) {
          return this.respondJsonFromRawResources_0('multiple_matches_response', dKodein);
        }
         else {
          return this.respondJsonFromRawResources_0('single_match_response', dKodein);
        }
      ...
      case '/match/42':
        return this.respondJsonFromRawResources_0('single_match_response', dKodein);
      case '/match/search/byTournament':
        return this.respondJsonFromRawResources_0('multiple_matches_response', dKodein);
      case '/match/search/byTournamentId':
        return this.respondJsonFromRawResources_0('multiple_matches_response', dKodein);
      case '/match/search/byTournamentId?tournamentId=42&page=1':
        return this.respondJsonFromRawResources_0('multiple_matches_response', dKodein);
      case '/match/search/byTournamentId?tournamentId=1&page=0':
        return this.respondJsonFromRawResources_0('multiple_matches_response', dKodein);
      case '/match/search/byTournamentId?tournamentId=1&page=1':
        return this.respondJsonFromRawResources_0('multiple_matches_response', dKodein);
      case '/match/search/byGame':
        return this.respondJsonFromRawResources_0('multiple_matches_response', dKodein);
      case '/match/search/byGameId':
        return this.respondJsonFromRawResources_0('multiple_matches_response', dKodein);
      case '/match/search/byMatchDateTimeIsAfter':
        return this.respondJsonFromRawResources_0('multiple_matches_response', dKodein);
      case '/match/search/availableMatches?page=0':
        return this.respondJsonFromRawResources_0('multiple_matches_response', dKodein);
      case '/match/search/notFull':
        return this.respondJsonFromRawResources_0('multiple_matches_response', dKodein);
      case '/match/search/byUserId?userId=Cesare_1&page=0':
        return this.respondJsonFromRawResources_0('multiple_matches_response', dKodein);
      case '/match/search/byUserId?userId=Cesare_1&page=1':
        return this.respondJsonFromRawResources_0('multiple_matches_response', dKodein);
      case '/match/search/byTournamentId?tournamentId=42&page=0':
        return this.respondJsonFromRawResources_0('multiple_matches_response', dKodein);
      case '/registration/1/match':
        return this.respondJsonFromRawResources_0('single_match_response', dKodein);
      case '/registration/2/match':
        return this.respondJsonFromRawResources_0('single_match_response', dKodein);
      case '/registration/3/match':
        return this.respondJsonFromRawResources_0('single_match_response', dKodein);
      case '/registration':
        return ((tmp$_3 = request.method) != null ? tmp$_3.equals(HttpMethod_0.Companion.Get) : null) ? this.respondJsonFromRawResources_0('multiple_registrations_response', dKodein) : this.respondJsonFromRawResources_0('single_registration_response', dKodein);
      case '/registration/1':
        return this.respondJsonFromRawResources_0('single_registration_response', dKodein);
      case '/registration/2':
        return this.respondJsonFromRawResources_0('single_registration_response', dKodein);
      case '/registration/3':
        return this.respondJsonFromRawResources_0('single_registration_response', dKodein);
      case '/registration/search/byUserId':
        return this.respondJsonFromRawResources_0('multiple_registrations_response', dKodein);
      case '/registration/search/byMatchId':
        return this.respondJsonFromRawResources_0('multiple_registrations_response', dKodein);
      case '/registration/search/byMatchId?matchId=1&page=0':
        return this.respondJsonFromRawResources_0('multiple_registrations_response', dKodein);
      case '/registration/search/byMatchId?matchId=1&page=1':
        return this.respondJsonFromRawResources_0('multiple_registrations_response', dKodein);
      case '/registration/search/byUserId?userId=User&page=0':
        return this.respondJsonFromRawResources_0('multiple_registrations_response', dKodein);
      case '/registration/search/byUserId?userId=User&page=1':
        return this.respondJsonFromRawResources_0('multiple_registrations_response', dKodein);
      case '/createUser':
        return this.respondJsonFromRawResources_0('single_user_response', dKodein);
      case '/currentUser':
        return this.respondJsonFromRawResources_0('single_user_response', dKodein);
      case '/user/Cesare_1':
        return this.respondJsonFromRawResources_0('single_user_response', dKodein);
      ...
      case '/user/Beppe_3':
        return this.respondJsonFromRawResources_0('single_user_response', dKodein);
      case '/user/search/byMatch':
        return this.respondJsonFromRawResources_0('multiple_users_response', dKodein);
      case '/user/search/byMatchId':
        return this.respondJsonFromRawResources_0('multiple_users_response', dKodein);
      case '/registration/1/user':
        return this.respondJsonFromRawResources_0('single_user_response', dKodein);
      case '/registration/2/user':
        return this.respondJsonFromRawResources_0('single_user_response', dKodein);
      case '/registration/3/user':
        return this.respondJsonFromRawResources_0('single_user_response', dKodein);
      case '/tournament/1/admin':
        return this.respondJsonFromRawResources_0('single_user_response', dKodein);
      case '/isAccountVerified':
        return this.respondJsonFromRawResources_0('verification_status_response', dKodein);
      case '/isAccountSubscribed':
        return this.respondJsonFromRawResources_0('subscription_status_response', dKodein);
      default:return this.buildMockEngineError_0(request);
    }
  };
  CommonMockModule.$metadata$ = {
    kind: Kind_OBJECT,
    simpleName: 'CommonMockModule',
    interfaces: [KodeinModuleProvider]
  };
  var CommonMockModule_instance = null;
  function CommonMockModule_getInstance() {
    if (CommonMockModule_instance === null) {
      new CommonMockModule();
    }
    return CommonMockModule_instance;
  }
  ...
  function NetworkModule$provideModule$lambda$lambda$lambda$lambda_0(this$) {
    return function ($receiver) {
      var $receiver_0 = this$;
      var tag = 'networkLogLevel';
      var tmp$ = $receiver_0.dkodein;
      var erased$result;
      try {
        erased$result = new JSTypeToken_init(getKClass(LogLevel));
      }
       catch (ex) {
        if (Kotlin.isType(ex, Throwable)) {
          throw IllegalArgumentException_init('Could not get KClass. Note that Kotlin does NOT support reflection over primitives.');
      ...
      $receiver.level = tmp$.Instance_xflu9r$(erased$result, tag);
      return Unit;
    };
  }
  function NetworkModule$provideModule$lambda$lambda$lambda(this$) {
    return function ($receiver) {
      $receiver.install_xlxg29$(JsonFeature.Feature, NetworkModule$provideModule$lambda$lambda$lambda$lambda);
      var tmp$ = this$.dkodein;
      var erased$result;
      try {
        erased$result = new JSTypeToken_init(PrimitiveClasses$booleanClass);
      }
       catch (ex) {
        if (Kotlin.isType(ex, Throwable)) {
          throw IllegalArgumentException_init('Could not get KClass. Note that Kotlin does NOT support reflection over primitives.');
      ...
      if (tmp$.Instance_xflu9r$(erased$result, 'isDebug'))
        $receiver.install_xlxg29$(Logging.Companion, NetworkModule$provideModule$lambda$lambda$lambda$lambda_0(this$));
      return Unit;
    };
  }
  function NetworkModule$provideModule$lambda$lambda($receiver) {
    return HttpClient_1(NetworkModule$provideModule$lambda$lambda$lambda($receiver));
  }
  ...
  function UseCasesModule$provideModule$lambda$lambda_6($receiver) {
    ...
    var erased$result_0;
    try {
      erased$result_0 = new JSTypeToken_init(getKClass(GetCurrentUserInfoUseCase));
    }
     catch (ex_0) {
      if (Kotlin.isType(ex_0, Throwable)) {
        throw IllegalArgumentException_init('Could not get KClass. Note that Kotlin does NOT support reflection over primitives.');
  ...
  function UseCasesModule$provideModule$lambda$lambda_9($receiver) {
    ...
    return new GetCurrentUserInfoUseCase(tmp$.Instance_xflu9r$(erased$result, null));
  }
  ...
  function UseCasesModule$provideModule$lambda$lambda_17($receiver) {
    ...
    var erased$result_0;
    try {
      erased$result_0 = new JSTypeToken_init(getKClass(AuthenticationManager));
    }
     catch (ex_0) {
      if (Kotlin.isType(ex_0, Throwable)) {
        throw IllegalArgumentException_init('Could not get KClass. Note that Kotlin does NOT support reflection over primitives.');
    ...
    return new CreateUserUseCase(tmp$_0, tmp$_1.Instance_xflu9r$(erased$result_0, null));
  }
  ...
  function UseCasesModule$provideModule$lambda($receiver) {
    ...
    var erased$result_19;
    try {
      erased$result_19 = new JSTypeToken_init(getKClass(GetCurrentUserInfoUseCase));
    }
     catch (ex_19) {
      if (Kotlin.isType(ex_19, Throwable)) {
        throw IllegalArgumentException_init('Could not get KClass. Note that Kotlin does NOT support reflection over primitives.');
    ...
    var erased$result_20;
    try {
      erased$result_20 = new JSTypeToken_init(getKClass(GetCurrentUserInfoUseCase));
    }
     catch (ex_20) {
      if (Kotlin.isType(ex_20, Throwable)) {
        throw IllegalArgumentException_init('Could not get KClass. Note that Kotlin does NOT support reflection over primitives.');
  ...
  function FirebaseAuthenticationManager(firebaseAuth) {
    this.firebaseAuth_0 = firebaseAuth;
  }
  Object.defineProperty(FirebaseAuthenticationManager.prototype, 'currentFirebaseUser_0', {
    get: function () {
      var tmp$;
      tmp$ = this.firebaseAuth_0.currentUser;
      if (tmp$ == null) {
        throw new AuthException$AuthNotAuthenticatedException();
      }
      return tmp$;
    }
  });
  FirebaseAuthenticationManager.prototype.loginWithEmailAndPassword_puj7f4$ = function (email, password, continuation) {
    return this.loginWithAuthCredential_0(credential(email, password), continuation);
  };
  FirebaseAuthenticationManager.prototype.loginWithFacebookToken_61zpoe$ = function (token, continuation) {
    return this.loginWithAuthCredential_0(credential_0(token), continuation);
  };
  FirebaseAuthenticationManager.prototype.loginWithGoogleToken_61zpoe$ = function (token, continuation) {
    return this.loginWithAuthCredential_0(credential_1(token), continuation);
  };
  function Coroutine$createAccountWithEmailAndPassword_puj7f4$($this, email_0, password_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.$this = $this;
  ...
  Coroutine$createAccountWithEmailAndPassword_puj7f4$.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$createAccountWithEmailAndPassword_puj7f4$.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$createAccountWithEmailAndPassword_puj7f4$.prototype.constructor = Coroutine$createAccountWithEmailAndPassword_puj7f4$;
  Coroutine$createAccountWithEmailAndPassword_puj7f4$.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = await_0(this.$this.firebaseAuth_0.createUserWithEmailAndPassword(this.local$email, this.local$password), this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  FirebaseAuthenticationManager.prototype.createAccountWithEmailAndPassword_puj7f4$ = function (email_0, password_0, continuation_0, suspended) {
    var instance = new Coroutine$createAccountWithEmailAndPassword_puj7f4$(this, email_0, password_0, continuation_0);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  };
  FirebaseAuthenticationManager.prototype.getToken = function (continuation) {
    return await_0(this.currentFirebaseUser_0.getIdToken(), continuation);
  };
  FirebaseAuthenticationManager.prototype.getCurrentUser = function () {
    var tmp$;
    return (tmp$ = this.firebaseAuth_0.currentUser) != null ? new AuthUserEntity(ensureNotNull(tmp$.uid), ensureNotNull(tmp$.email)) : null;
  };
  FirebaseAuthenticationManager.prototype.getCurrentUserAuthMethods = function (continuation) {
    return this.fetchAvailableAuthMethodsByEmail_0(ensureNotNull(this.currentFirebaseUser_0.email), continuation);
  };
  FirebaseAuthenticationManager.prototype.linkGoogleAuthProvider_61zpoe$ = function (token, continuation) {
    return this.linkWithCredentials_0(credential_1(token), continuation);
  };
  FirebaseAuthenticationManager.prototype.linkFacebookAuthProvider_61zpoe$ = function (token, continuation) {
    return this.linkWithCredentials_0(credential_0(token), continuation);
  };
  FirebaseAuthenticationManager.prototype.linkPasswordAuthProvider_61zpoe$ = function (password, continuation) {
    return this.linkWithCredentials_0(credential(ensureNotNull(this.currentFirebaseUser_0.email), password), continuation);
  };
  FirebaseAuthenticationManager.prototype.reauthenticateWithPassword_61zpoe$ = function (password, continuation) {
    return this.reauthenticate_0(credential(ensureNotNull(this.currentFirebaseUser_0.email), password), continuation);
  };
  FirebaseAuthenticationManager.prototype.reauthenticateWithGoogleToken_61zpoe$ = function (token, continuation) {
    return this.reauthenticate_0(credential_1(token), continuation);
  };
  FirebaseAuthenticationManager.prototype.reauthenticateWithFacebook_61zpoe$ = function (token, continuation) {
    return this.reauthenticate_0(credential_0(token), continuation);
  };
  function Coroutine$loginWithAuthCredential_0($this, authCredential_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 4;
    this.$this = $this;
    this.local$authCredential = authCredential_0;
  }
  Coroutine$loginWithAuthCredential_0.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$loginWithAuthCredential_0.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$loginWithAuthCredential_0.prototype.constructor = Coroutine$loginWithAuthCredential_0;
  Coroutine$loginWithAuthCredential_0.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            this.exceptionState_0 = 2;
            this.state_0 = 1;
            this.result_0 = await_0(this.$this.firebaseAuth_0.signInWithCredential(this.local$authCredential), this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  FirebaseAuthenticationManager.prototype.loginWithAuthCredential_0 = function (authCredential_0, continuation_0, suspended) {
    var instance = new Coroutine$loginWithAuthCredential_0(this, authCredential_0, continuation_0);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  };
  function Coroutine$fetchAvailableAuthMethodsByEmail_0($this, email_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 4;
    this.$this = $this;
    this.local$email = email_0;
  }
  Coroutine$fetchAvailableAuthMethodsByEmail_0.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$fetchAvailableAuthMethodsByEmail_0.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$fetchAvailableAuthMethodsByEmail_0.prototype.constructor = Coroutine$fetchAvailableAuthMethodsByEmail_0;
  Coroutine$fetchAvailableAuthMethodsByEmail_0.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            this.exceptionState_0 = 2;
            this.state_0 = 1;
            this.result_0 = await_0(this.$this.firebaseAuth_0.fetchSignInMethodsForEmail(this.local$email), this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
            ...
            while (tmp$.hasNext()) {
              ...
              if (equals(element, $module$firebase.firebase.auth.EmailAuthProvider.EMAIL_PASSWORD_SIGN_IN_METHOD)) {
                transform$result = AuthProviders.EMAIL_PASSWORD;
              }
               else if (equals(element, $module$firebase.firebase.auth.FacebookAuthProvider.FACEBOOK_SIGN_IN_METHOD)) {
                transform$result = AuthProviders.FACEBOOK;
              }
               else if (equals(element, $module$firebase.firebase.auth.GoogleAuthProvider.GOOGLE_SIGN_IN_METHOD)) {
                transform$result = AuthProviders.GOOGLE;
              }
               else {
  ...
  FirebaseAuthenticationManager.prototype.fetchAvailableAuthMethodsByEmail_0 = function (email_0, continuation_0, suspended) {
    var instance = new Coroutine$fetchAvailableAuthMethodsByEmail_0(this, email_0, continuation_0);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  };
  function Coroutine$reauthenticate_0($this, authCredential_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 4;
    this.$this = $this;
    this.local$authCredential = authCredential_0;
  }
  Coroutine$reauthenticate_0.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$reauthenticate_0.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$reauthenticate_0.prototype.constructor = Coroutine$reauthenticate_0;
  Coroutine$reauthenticate_0.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            this.exceptionState_0 = 2;
            this.state_0 = 1;
            this.result_0 = await_0(this.$this.currentFirebaseUser_0.reauthenticateWithCredential(this.local$authCredential), this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  FirebaseAuthenticationManager.prototype.reauthenticate_0 = function (authCredential_0, continuation_0, suspended) {
    var instance = new Coroutine$reauthenticate_0(this, authCredential_0, continuation_0);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  };
  function Coroutine$linkWithCredentials_0($this, authCredential_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 4;
    this.$this = $this;
    this.local$authCredential = authCredential_0;
  }
  Coroutine$linkWithCredentials_0.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$linkWithCredentials_0.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$linkWithCredentials_0.prototype.constructor = Coroutine$linkWithCredentials_0;
  Coroutine$linkWithCredentials_0.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            this.exceptionState_0 = 2;
            this.state_0 = 1;
            this.result_0 = await_0(this.$this.currentFirebaseUser_0.linkWithCredential(this.local$authCredential), this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  FirebaseAuthenticationManager.prototype.linkWithCredentials_0 = function (authCredential_0, continuation_0, suspended) {
    var instance = new Coroutine$linkWithCredentials_0(this, authCredential_0, continuation_0);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  };
  FirebaseAuthenticationManager.prototype.asCustom_0 = function ($receiver) {
    switch ($receiver.message) {
      case 'auth/weak-password':
        return new AuthException$AuthWeakPasswordException();
      case 'auth/invalid-credential':
      case 'auth/wrong-password':
      case 'auth/invalid-email':
        return new AuthException$AuthInvalidCredentialsException($receiver.message);
      case 'auth/account-exists-with-different-credential':
        return new AuthException$AuthUserCollisionException();
      case 'auth/operation-not-allowed':
      case 'auth/user-disabled':
      case 'auth/user-not-found':
        return new AuthException$AuthInvalidUserException();
      case 'auth/requires-recent-login':
        return new AuthException$AuthRecentLoginRequiredException();
      default:return new AuthException$AuthGenericException($receiver.message);
    }
  };
  FirebaseAuthenticationManager.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'FirebaseAuthenticationManager',
    interfaces: [AuthenticationManager]
  };
  function JsDependencyContainer(serverProtocol, serverUrl, serverPort) {
    this.kodein_4wxa99$_0 = Kodein.Companion.lazy_z3stfd$(void 0, JsDependencyContainer$kodein$lambda(serverProtocol, serverUrl, serverPort));
    var erased$result;
    try {
    ...
    this.createGame_l62qnl$_0 = Instance(this, erased$result, null).provideDelegate_tpuvb9$(this, JsDependencyContainer$createGame_metadata);
    var erased$result_0;
    try {
    ...
    this.getGamesByMode_2wizk8$_0 = Instance(this, erased$result_0, null).provideDelegate_tpuvb9$(this, JsDependencyContainer$getGamesMode_metadata);
    var erased$result_1;
    try {
    ...
    this.getGamesContainingName_srwmdj$_0 = Instance(this, erased$result_1, null).provideDelegate_tpuvb9$(this, JsDependencyContainer$getGamesContainingName_metadata);
    var erased$result_2;
    try {
    ...
    this.createMatch_e3y9le$_0 = Instance(this, erased$result_2, null).provideDelegate_tpuvb9$(this, JsDependencyContainer$createMatch_metadata);
    var erased$result_3;
    try {
    ...
    this.getAllAvailableMatches_rjap4o$_0 = Instance(this, erased$result_3, null).provideDelegate_tpuvb9$(this, JsDependencyContainer$getAllAvailableMatches_metadata);
    var erased$result_4;
    try {
    ...
    this.getAllMatchesByUser_ejijg3$_0 = Instance(this, erased$result_4, null).provideDelegate_tpuvb9$(this, JsDependencyContainer$getAllMatchesByUser_metadata);
    var erased$result_5;
    try {
    ...
    this.getAllMatchesByTournament_yclelr$_0 = Instance(this, erased$result_5, null).provideDelegate_tpuvb9$(this, JsDependencyContainer$getAllMatchesByTournament_metadata);
    var erased$result_6;
    try {
    ...
    this.createGameModeUseCase_jxxryn$_0 = Instance(this, erased$result_6, null).provideDelegate_tpuvb9$(this, JsDependencyContainer$createGameMode_metadata);
    var erased$result_7;
    try {
    ...
    this.createRegistration_k8ehjs$_0 = Instance(this, erased$result_7, null).provideDelegate_tpuvb9$(this, JsDependencyContainer$createRegistration_metadata);
    var erased$result_8;
    try {
    ...
    this.getAllRegistrationsByMatch_x31r9a$_0 = Instance(this, erased$result_8, null).provideDelegate_tpuvb9$(this, JsDependencyContainer$getAllRegistrationsByMatch_metadata);
    var erased$result_9;
    try {
    ...
    this.getAllRegistrationsByTournament_k2wnx4$_0 = Instance(this, erased$result_9, null).provideDelegate_tpuvb9$(this, JsDependencyContainer$getAllRegistrationsByTournament_metadata);
    var erased$result_10;
    try {
    ...
    this.getAllRegistrationsByUser_uvp01m$_0 = Instance(this, erased$result_10, null).provideDelegate_tpuvb9$(this, JsDependencyContainer$getAllRegistrationsByUser_metadata);
    var erased$result_11;
    try {
    ...
    this.createTournament_ghdxvs$_0 = Instance(this, erased$result_11, null).provideDelegate_tpuvb9$(this, JsDependencyContainer$createTournament_metadata);
    var erased$result_12;
    try {
    ...
    this.getCreatedTournamentsByAdmin_din90j$_0 = Instance(this, erased$result_12, null).provideDelegate_tpuvb9$(this, JsDependencyContainer$getCreatedTournamentsByAdmin_metadata);
    var erased$result_13;
    try {
    ...
    this.getShowcaseTournaments_dwo71y$_0 = Instance(this, erased$result_13, null).provideDelegate_tpuvb9$(this, JsDependencyContainer$getShowcaseTournaments_metadata);
    var erased$result_14;
    try {
    ...
    this.getTournamentsByGame_oh5bnk$_0 = Instance(this, erased$result_14, null).provideDelegate_tpuvb9$(this, JsDependencyContainer$getTournamentsByGame_metadata);
    var erased$result_15;
    try {
    ...
    this.getTournamentsByMode_okoucv$_0 = Instance(this, erased$result_15, null).provideDelegate_tpuvb9$(this, JsDependencyContainer$getTournamentsByMode_metadata);
    var erased$result_16;
    try {
    ...
    this.getTournamentsContainingTitle_e42vof$_0 = Instance(this, erased$result_16, null).provideDelegate_tpuvb9$(this, JsDependencyContainer$getTournamentsContainingTitle_metadata);
    var erased$result_17;
    try {
    ...
    this.createUser_ky2a7e$_0 = Instance(this, erased$result_17, null).provideDelegate_tpuvb9$(this, JsDependencyContainer$createUser_metadata);
    var erased$result_18;
    try {
    ...
    this.getAccountVerificationStatusUseCase_20puqs$_0 = Instance(this, erased$result_18, null).provideDelegate_tpuvb9$(this, JsDependencyContainer$getAccountVerificationStatusUseCase_metadata);
    var erased$result_19;
    try {
    ...
    this.getUserInfo_v9eth4$_0 = Instance(this, erased$result_19, null).provideDelegate_tpuvb9$(this, JsDependencyContainer$getUserInfo_metadata);
    var erased$result_20;
    try {
    ...
    this.isSubscribed_n51fr$_0 = Instance(this, erased$result_20, null).provideDelegate_tpuvb9$(this, JsDependencyContainer$isSubscribed_metadata);
  }
  ...
  Object.defineProperty(JsDependencyContainer.prototype, 'kodein', {
    get: function () {
      return this.kodein_4wxa99$_0.getValue_n5byny$(this, JsDependencyContainer$kodein_metadata);
    }
  });
  ...
  Object.defineProperty(JsDependencyContainer.prototype, 'createGame', {
    get: function () {
      return this.createGame_l62qnl$_0.value;
    }
  });
  ...
  Object.defineProperty(JsDependencyContainer.prototype, 'getGamesByMode', {
    get: function () {
      return this.getGamesByMode_2wizk8$_0.value;
    }
  });
  ...
  Object.defineProperty(JsDependencyContainer.prototype, 'getGamesContainingName', {
    get: function () {
      return this.getGamesContainingName_srwmdj$_0.value;
    }
  });
  ...
  Object.defineProperty(JsDependencyContainer.prototype, 'createMatch', {
    get: function () {
      return this.createMatch_e3y9le$_0.value;
    }
  });
  ...
  Object.defineProperty(JsDependencyContainer.prototype, 'getAllAvailableMatches', {
    get: function () {
      return this.getAllAvailableMatches_rjap4o$_0.value;
    }
  });
  ...
  Object.defineProperty(JsDependencyContainer.prototype, 'getAllMatchesByUser', {
    get: function () {
      return this.getAllMatchesByUser_ejijg3$_0.value;
    }
  });
  ...
  Object.defineProperty(JsDependencyContainer.prototype, 'getAllMatchesByTournament', {
    get: function () {
      return this.getAllMatchesByTournament_yclelr$_0.value;
    }
  });
  ...
  Object.defineProperty(JsDependencyContainer.prototype, 'createGameModeUseCase', {
    get: function () {
      return this.createGameModeUseCase_jxxryn$_0.value;
    }
  });
  ...
  Object.defineProperty(JsDependencyContainer.prototype, 'createRegistration', {
    get: function () {
      return this.createRegistration_k8ehjs$_0.value;
    }
  });
  ...
  Object.defineProperty(JsDependencyContainer.prototype, 'getAllRegistrationsByMatch', {
    get: function () {
      return this.getAllRegistrationsByMatch_x31r9a$_0.value;
    }
  });
  ...
  Object.defineProperty(JsDependencyContainer.prototype, 'getAllRegistrationsByTournament', {
    get: function () {
      return this.getAllRegistrationsByTournament_k2wnx4$_0.value;
    }
  });
  ...
  Object.defineProperty(JsDependencyContainer.prototype, 'getAllRegistrationsByUser', {
    get: function () {
      return this.getAllRegistrationsByUser_uvp01m$_0.value;
    }
  });
  ...
  Object.defineProperty(JsDependencyContainer.prototype, 'createTournament', {
    get: function () {
      return this.createTournament_ghdxvs$_0.value;
    }
  });
  ...
  Object.defineProperty(JsDependencyContainer.prototype, 'getCreatedTournamentsByAdmin', {
    get: function () {
      return this.getCreatedTournamentsByAdmin_din90j$_0.value;
    }
  });
  ...
  Object.defineProperty(JsDependencyContainer.prototype, 'getShowcaseTournaments', {
    get: function () {
      return this.getShowcaseTournaments_dwo71y$_0.value;
    }
  });
  ...
  Object.defineProperty(JsDependencyContainer.prototype, 'getTournamentsByGame', {
    get: function () {
      return this.getTournamentsByGame_oh5bnk$_0.value;
    }
  });
  ...
  Object.defineProperty(JsDependencyContainer.prototype, 'getTournamentsByMode', {
    get: function () {
      return this.getTournamentsByMode_okoucv$_0.value;
    }
  });
  ...
  Object.defineProperty(JsDependencyContainer.prototype, 'getTournamentsContainingTitle', {
    get: function () {
      return this.getTournamentsContainingTitle_e42vof$_0.value;
    }
  });
  ...
  Object.defineProperty(JsDependencyContainer.prototype, 'createUser', {
    get: function () {
      return this.createUser_ky2a7e$_0.value;
    }
  });
  ...
  Object.defineProperty(JsDependencyContainer.prototype, 'getAccountVerificationStatusUseCase', {
    get: function () {
      return this.getAccountVerificationStatusUseCase_20puqs$_0.value;
    }
  });
  ...
  Object.defineProperty(JsDependencyContainer.prototype, 'getUserInfo', {
    get: function () {
      return this.getUserInfo_v9eth4$_0.value;
    }
  });
  ...
  Object.defineProperty(JsDependencyContainer.prototype, 'isSubscribed', {
    get: function () {
      return this.isSubscribed_n51fr$_0.value;
    }
  });
  function JsDependencyContainer$kodein$lambda(closure$serverProtocol, closure$serverUrl, closure$serverPort) {
    return function ($receiver) {
  ...
  function JsUseCasesModule$provideModule$lambda$lambda_18($receiver) {
    ...
    var erased$result;
    try {
      erased$result = new JSTypeToken_init(getKClass(GetCurrentUserInfoUseCase));
    }
     catch (ex) {
      if (Kotlin.isType(ex, Throwable)) {
        throw IllegalArgumentException_init('Could not get KClass. Note that Kotlin does NOT support reflection over primitives.');
  ...
  function PlatformSpecificMockModule() {
    PlatformSpecificMockModule_instance = this;
  }
  function PlatformSpecificMockModule$provideModule$lambda($receiver) {
    return Unit;
  }
  PlatformSpecificMockModule.prototype.provideModule = function () {
    return PlatformSpecificMockModule$provideModule$lambda;
  };
  PlatformSpecificMockModule.$metadata$ = {
    kind: Kind_OBJECT,
    simpleName: 'PlatformSpecificMockModule',
    interfaces: [KodeinModuleProvider]
  };
  var PlatformSpecificMockModule_instance = null;
  function PlatformSpecificMockModule_getInstance() {
    if (PlatformSpecificMockModule_instance === null) {
      new PlatformSpecificMockModule();
    }
    return PlatformSpecificMockModule_instance;
  }
  ...
  Object.defineProperty(package$modules, 'AuthModule', {
    get: AuthModule_getInstance
  });
  package$modules.buildCommonKodein_jh0kmz$ = buildCommonKodein;
  Object.defineProperty(package$modules, 'CommonMockModule', {
    get: CommonMockModule_getInstance
  });
  ...
  package$auth.getFirebaseAuthInstance = getFirebaseAuthInstance;
  package$auth.FirebaseAuthenticationManager = FirebaseAuthenticationManager;
  var package$jsbindings = package$myapplication.jsbindings || (package$myapplication.jsbindings = {});
  ...
  Object.defineProperty(package$modules, 'PlatformSpecificMockModule', {
    get: PlatformSpecificMockModule_getInstance
  });
